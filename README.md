...
- `KAMIYA_ALLOWED_ORIGIN`: comma-separated web client origins for CORS. Local defaults include Kamiya on `http://localhost:5173` and Resonera on ports `3000` or `3001`.
